    ...
    <div className="flex flex-col justify-center items-center bg-black text-white">
      ...
      <div style={{ minHeight: '95vh' }} className="flex flex-col items-center justify-center gap-4 w-full">
        ...
        <div className="flex flex-row items-center justify-center gap-4">
          ...
          <button onClick={addNewTask} className="px-4 py-2 rounded-xl border-green-400 bg-white text-black transform hover:scale-105">Add Task</button>
        </div>
        {/*All Tasks*/}
        <div className="flex items-center justify-center flex-col">
          {
            tasks.length > 0 && tasks.map((taskItem, i) => {
              return (
